#!/usr/bin/env python3
"""
Change Detection Script for ARES
...
def detect_changes():
    ...
    project_path = Path("/home/user01/projects/active-projects/ARES")
    change_patterns = ["*.py", "*.yaml", "*.json"]
    regeneration_triggers = ["ares/", "tests/", "src/"]
